...
const DetailInformation = ({ isOpen, setIsOpen, idFolder }) => {
    ...
    // eslint-disable-next-line no-unused-vars
    const data = dataDetail?.getFolderById?.createdBy;
    return (
        <div>
            {' '}
            <ModalComponent
            ...
            >
                <div className="mb-3 max-h-[900px] min-h-[424px] w-[680px] p-6">
                    ...
                    <div className="mt-6">
                        ...
                        <p className="border-x border-b p-2 text-sm font-normal ">
                    ...
                    <div className="">
                        ...
                        <div className=" border p-2">
                            <div className="custom-scroll-y max-h-[250px]  p-2">
                    ...
                    <div className="flex border-x border-b  ">
                        <div className=" w-full  ">
                            <p className="border-b bg-[#F4F4F4] p-2 text-sm font-semibold">Creator</p>
                    ...
                    <div className=" flex  border-x border-b">
                        <div className=" w-[50%] border-r">
                            <p className="border-b bg-[#F4F4F4] p-2 text-sm font-semibold">Created at</p>
                            <div className=" flex gap-2 p-2">
                                <p className="text-sm ">{toDateStrings(dataDetail?.getFolderById?.createdAt)}</p>
                            </div>
                        </div>
                        <div className=" w-[50%]">
                            <p className="border-b bg-[#F4F4F4] p-2 text-sm font-semibold">Updated at</p>
                            <div className=" flex gap-2 p-2">
                                <p className="text-sm ">{toDateTimeString(dataDetail?.getFolderById?.updatedAt)}</p>
                            </div>
                        </div>
                    </div>
                </div>
