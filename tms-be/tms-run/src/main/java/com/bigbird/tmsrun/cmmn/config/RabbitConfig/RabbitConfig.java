...
public class RabbitConfig {
    ...
    public Queue authRequestQueue() {
        return new Queue(RabbitConstant.AUTH_REQUEST_QUEUE);
    }
    ...
    @Bean
    public Queue issuesCauseSolutionResponseQueue() {
        return new Queue(RabbitConstant.RUN_ISSUES_CAUSE_SOLUTION_RESPONSE_QUEUE, true);
    }
    ...
    @Bean
    public Queue saveIssuesCauseSolutionResponseQueue() {
        return new Queue(RabbitConstant.SAVE_ISSUES_CAUSE_SOLUTION_RESPONSE_QUEUE, true);
    }
